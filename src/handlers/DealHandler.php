...
class DealHandler
{
    ...
    {   
        ...
        {
            case 'CRMToERP':
                return DealFunctions::processPloomesDeal($args, $this->ploomesServices, $action);
                break;
            case 'CRMToOMNI':
                return TasksFunctions::processPloomesOmnismart($args, $this->ploomesServices, $this->rdstationServices, $action);
                break;
    ...
    public function confirmActionDealFromSaveWebhook($args)
    {

        return DealFunctions::confirmActionDealFromSaveWebhook($args, $this->ploomesServices); 
